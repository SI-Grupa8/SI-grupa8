...
(
    ...
    "CreatedDate" timestamp with time zone NOT NULL DEFAULT '-infinity'::timestamp with time zone,
    "Description" text COLLATE pg_catalog."default" NOT NULL DEFAULT ''::text,
    "ImageUrl" text COLLATE pg_catalog."default" NOT NULL DEFAULT ''::text,
...
INSERT INTO public."DeviceTypes"(
